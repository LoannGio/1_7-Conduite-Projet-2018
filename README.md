...
|US#3|En tant que développeur, je souhaite créer un projet(__Nom__, description, __génération d'un backlog vide__) afin de commencer la gestion de ce projet.||1|TODO|3|
...
|US#27|En tant que développeur, je souhaite créer et modifier un graphe de dépendances à partir de la liste des tâches et collaborateurs afin de visualiser l'ordre de réalisation des tâches et proposer une répartition.||13|TODO|23|
