...
|US#18|En tant que développeur, je souhaite modifier ou supprimer une tâche qui n'est ni en cours de réalisation, ni déjà réalisée (__TODO__), afin de la mettre à jour ou bien de la supprimer du Sprint.|Haute|3|TODO|Sprint 4|
|US#19|En tant que développeur, je souhaite pouvoir générer un graphe de dépendances à partir de la liste des tâches afin de visualiser l'ordre de réalisation des tâches et de proposer une répartition de ces dernières.|Basse|13|TODO|Sprint 5|
|US#20|En tant que développeur, je souhaite visualiser le burndown chart (tableau d'avancement des tâches) afin d'avoir un bilan de l'avancement du projet dans le temps.|Basse|8|TODO|Sprint 4||
