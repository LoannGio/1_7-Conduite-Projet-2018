...
|US#11|En tant que développeur, dans un projet, je souhaite créer et supprimer un Sprint(__date de début__, description, __User Stories liées__) afin d'organiser des listes de tâches.|Haute|2|TODO|Sprint 2|
...
|US#20|En tant que développeur, je souhaite visualiser le burndown chart (tableau d'avancement des tâches) afin d'avoir un bilan de l'avancement du sprint dans le temps.|Basse|8|TODO|Sprint 3||
