...
|US#11|En tant que développeur, dans un projet, je souhaite créer et supprimer un Sprint(__date de début__, description, __3 colonnes-états : TODO, ONGOING, DONE__) afin d'organiser des listes de tâches.||2|TODO|11|
|US#12|En tant que développeur, je souhaite visualiser la liste des Sprint d'un projet.||2|TODO|12|
|US#13|En tant que développeur, je souhaite créer une tâche (__Id__, __description__, __durée__, __tâches dépendantes__, __user stories associées__, __état__, __planification__) afin de l'ajouter à un Sprint.||1|TODO|13|
|US#14|En tant que développeur, je souhaite visualiser la liste des tâches d'un Sprint.||2|TODO|14|
