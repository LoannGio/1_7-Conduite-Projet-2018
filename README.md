...
|US#10|En tant que développeur, dans un projet, je souhaite modifier une User Story(description, priorité, difficulté, US dépendantes, état, planification) afin de la mettre à jour.|Haute|3|TODO|10|
|US#11|En tant que développeur, dans un projet, je souhaite créer et supprimer un Sprint(__date de début__, description) afin d'organiser des listes de tâches.|Haute|2|TODO|11|
|US#12|En tant que développeur, je souhaite visualiser la liste des Sprint d'un projet.|Haute|2|TODO|12|
|US#13|En tant que développeur, je souhaite créer une tâche (__Id__, __description__, __durée__, __tâches dépendantes__, __user stories associées__, __état: 3 possibles TODO, ONGOING, DONE__, __planification__) afin de l'ajouter à un Sprint.|Haute|1|TODO|13|
|US#14|En tant que développeur, je souhaite visualiser la liste des tâches d'un Sprint.|Haute|2|TODO|14|
|US#15|En tant que développeur, je souhaite m'approprier une tâche (__état de la tâche TODO à ONGOING__, datation du __début de réalisation__, __nom du réalisateur__) afin de la réaliser.|Haute|3|TODO|15|
...
|US#17|En tant que développeur, je souhaite modifier ou supprimer une tâche qui n'est ni en cours de réalisation, ni déjà réalisée (__TODO__), afin de la mettre à jour ou bien de la supprimer du Sprint.|Haute|3|TODO|17|
|US#18|En tant que développeur, je souhaite pouvoir générer un graphe de dépendances à partir de la liste des tâches afin de visualiser l'ordre de réalisation des tâches et de proposer une répartition de ces dernières.|Basse|13|TODO|18|
|US#19|En tant que développeur, je souhaite visualiser le burndown chart (tableau d'avancement des tâches) afin d'avoir un bilan de l'avancement du sprint dans le temps.|Basse|8|TODO|19||
